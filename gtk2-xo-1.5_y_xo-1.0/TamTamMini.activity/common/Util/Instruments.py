...
def _addInstrument(name, csoundInstrumentId,
    instrumentRegister, category,
    loopStart, loopEnd, crossDur,
    ampScale=1, kit=None, kitStage=False,
    volatile=False, nameTooltip=""):
        
    instrumentDB.addInstrumentFromArgs(name, csoundInstrumentId,
        instrumentRegister, loopStart,
        loopEnd, crossDur, ampScale, kit,
        name, imagefile(name + '.png'),
        category, kitStage=kitStage,
...
_addInstrument("MurgaBombo", INST_SIMP, PUNCH, 'percussions', 0, 0, 0, 1)
_addInstrument("MurgaPlatillos", INST_SIMP, PUNCH, 'percussions', 0, 0, 0, 1)
_addInstrument("MurgaRedoblante", INST_SIMP, PUNCH, 'percussions', 0, 0, 0, 1)
_addInstrument("CandombeChico", INST_SIMP, PUNCH, 'percussions', 0, 0, 0, 1)
_addInstrument("CandombePiano", INST_SIMP, PUNCH, 'percussions', 0, 0, 0, 1)
_addInstrument("CandombeRepique", INST_SIMP, PUNCH, 'percussions', 0, 0, 0, 1)
