...
class Instrument():
    ...
    def loadFromArgs(self, name, csoundInstrumentId,
        register, loopStart, loopEnd, crossDur, ampScale,
        kit, wav, img, category, nameTooltip=""):
        """
...
class InstrumentDB():
    ...
    def addInstrumentFromArgs(self, name, csoundInstrumentId,
        register, loopStart, loopEnd, crossDur, ampScale,
        kit, wav, img, category, kitStage=False,
        ...
        i.loadFromArgs(
            name, csoundInstrumentId, register,
    ...
    def addInstrument(self, path):
        ...
        # FIXME: category no está definido
        if not self.labelSet.has_key(category):
            self.labelSet[category] = set([])
