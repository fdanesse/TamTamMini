...
class Tooltips():
    ...
    def __init__(self):
        ...
        #InstrumentBox
        self.Edit["2instrument1muteButton"] = _(
            "Left click to mute,right click to solo")
        self.Edit["2instrument2muteButton"] = _(
            "Left click to mute, right click to solo")
        self.Edit["2instrument3muteButton"] = _(
            "Left click to mute, right click to solo")
        self.Edit["2instrument4muteButton"] = _(
            "Left click to mute, right click to solo")
        self.Edit["2drumMuteButton"] = _(
            "Left click to mute, right click to solo")

        self.ALGO = {}
        self.ALGO["XYButton1"] = _(
            '-- Rhythm density, | Rhythm regularity')
        self.ALGO["XYButton2"] = _(
            '-- Pitch regularity, | Pitch maximum step')
        self.ALGO["XYButton3"] = _(
            '-- Average duration, | Silence probability')
    ...
    MT_RECORDBUTTONS = [
        ...
        _('Record microphone into slot 4')]
