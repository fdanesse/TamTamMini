...
CSOUND_UNLOAD_TABLES = 'i%d 0 0.1 %d' % (
    INST_FREE, 150)  # removed magic number
CSOUND_NOTE_OFF = 'i %s.%s .2 0.01 1. 0. 0. 0.5 %d 0 0 0 0' % (
...
MAXIMUM_PITCH_DRUM = MINIMUM_PITCH_DRUM + PITCH_STEP_DRUM*(
    NUMBER_OF_POSSIBLE_PITCHES_DRUM - 1)
