...
class XYSlider(gtk.EventBox):
    ...
    def __init__(self, fixed, button,
    ...
    def updateLoc( self ):
        ...
        if self.flipX:
            self.x = (self.width * int(
            self.xadjustment.upper - self.xadjustment.value)) / self.xRange
            
        else:
            self.x = (self.width * int(
            self.xadjustment.value - self.xadjustment.lower)) / self.xRange
            
        if self.flipY:
            self.y = (self.height * int(
            self.yadjustment.upper - self.yadjustment.value)) / self.yRange
            
        else:
            self.y = (self.height * int(
            self.yadjustment.value - self.yadjustment.lower)) / self.yRange
    ...
    def updatePointer(self, x, y):
        ...
        if self.flipY:
            yvalue = self.yadjustment.lower + (self.yRange * (self.height - y)) / self.height
...
class keyButton(gtk.Button):
    ...
    def draw(self):
        ...
        self.draw_round_rect(
            self.cr,self.drawX - self.width / 2,
            self.drawY - self.height / 2,
